...
const AdminDashboard = () => {
  ...
  //   // Update charts for the selected user with pink/violet colors
  //   setChartData({
  //     statusData: {
  //       labels: ['Completed', 'Pending'],
  //       datasets: [{
  //         data: [completedTasks.length, pendingTasks.length],
  //         backgroundColor: [colors.pink.primary, colors.violet.primary],
  //         borderColor: [colors.pink.dark, colors.violet.dark],
  //         borderWidth: 1,
  ...
  //     // Reset charts to show overall data with pink/violet colors
  ...
  //   const selectedUserName='All Users'
  ...
  <MDBTypography tag="h1" className="welcome-title font-weight-bold text-dark">
    Welcome to ClearlyTasks
  </MDBTypography>
  <p className="mb-0 text-secondary">
    Monitor performance, manage tasks, and oversee team activities efficiently.
  </p>
</div>

      <MDBRow className="g-4 mb-4">
        <MDBCol xl="3" sm="6">
          <MDBCard className="h-100 border-0 shadow-sm" style={{ backgroundColor: colors.pink.light }}>
            <MDBCardBody>
        ...
        <MDBCol xl="3" sm="6">
          <MDBCard className="h-100 border-0 shadow-sm" style={{ backgroundColor: colors.violet.light }}>
            <MDBCardBody>
              <div className="d-flex justify-content-between align-items-center">
                <div>
                ...
                <MDBIcon fas icon="tasks" size="2x" style={{ color: colors.violet.dark }} />
              </div>
            </MDBCardBody>
          </MDBCard>
        </MDBCol>
        ...
        <MDBCol xl="3" sm="6">
          <MDBCard className="h-100 border-0 shadow-sm" style={{ backgroundColor: colors.fuchsia.light }}>
            <MDBCardBody>
              <div className="d-flex justify-content-between align-items-center">
                <div>
                  <MDBTypography tag='h6' className="fs-6 text-muted mb-2">Pending Tasks</MDBTypography>
                  <MDBTypography tag='h3' className="mb-0" style={{ color: colors.fuchsia.dark }}>
                    {selectedUser === 'all' ? stats.pendingTasks : userStats?.pendingTasks || 0}
                  </MDBTypography>
                </div>
                <MDBIcon fas icon="clock" size="2x" style={{ color: colors.fuchsia.dark }} />
              </div>
            </MDBCardBody>
          </MDBCard>
        </MDBCol>
        ...
        <MDBCol xl="3" sm="6">
          <MDBCard className="h-100 border-0 shadow-sm" style={{ backgroundColor: '#d1fae5' }}>
            <MDBCardBody>
              <div className="d-flex justify-content-between align-items-center">
                <div>
                  <MDBTypography tag='h6' className="fs-6 text-muted mb-2">Completed Tasks</MDBTypography>
                  <MDBTypography tag='h3' className="mb-0" style={{ color: colors.success }}>
          ...
          <MDBCard className="border-0 shadow-sm">
            <MDBCardBody>
              <div className="d-flex align-items-center">
                <MDBIcon fas icon="user" className="me-2" style={{ color: colors.pink.primary }} />
                <h5 className="mb-0 me-3" style={{ color: colors.pink.dark }}>All:</h5>
                <h5 value="all"></h5>
                <select 
      ...
      {/* <MDBRow className="g-4 mb-4">
        <MDBCol md="6">
          <MDBCard className="border-0 shadow-sm">
            <MDBCardBody>
              <h5 className="mb-4 text-center" style={{ color: colors.pink.dark }}>
        ...
        <MDBCol md="6">
          <MDBCard className="border-0 shadow-sm">
            <MDBCardBody>
              <h5 className="mb-4 text-center" style={{ color: colors.violet.dark }}>
      ...
      {/* Task Priority Breakdown Table */}
      {/* {selectedUserData && (
        <MDBRow>
          <MDBCol>
            <MDBCard className="border-0 shadow-sm">
              <MDBCardBody>
                <h5 className="mb-4 text-center" style={{ color: colors.fuchsia.dark }}>
                  Task Priority Breakdown for {selectedUserData.username}
                </h5>
                <MDBTable align='middle' hover responsive>
                  <MDBTableHead style={{ backgroundColor: colors.pink.light }}>
                    <tr>
                      <th scope='col' style={{ color: colors.pink.dark }}>Priority Level</th>
                      <th scope='col' className="text-center" style={{ color: colors.pink.dark }}>Number of Tasks</th>
                      <th scope='col' className="text-center" style={{ color: colors.pink.dark }}>Percentage</th>
                    </tr>
                  </MDBTableHead>
                  <MDBTableBody>
                    <tr>
                    ...
                    <tr style={{ backgroundColor: colors.violet.light }}>
                      <td style={{ fontWeight: '600', color: colors.violet.dark }}>Total</td>
                      <td className="text-center" style={{ fontWeight: '600', color: colors.violet.dark }}>{selectedUserData.totalTasks}</td>
                      <td className="text-center" style={{ fontWeight: '600', color: colors.violet.dark }}>100%</td>
                    </tr>
                  </MDBTableBody>
                </MDBTable>
              </MDBCardBody>
